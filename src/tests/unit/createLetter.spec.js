...
describe('Create Letter', () => {
    ...
    it('Have property "rows" with the value equal 2', () => {
        const letter = new createLetter('A', 'Afonso', 2, 0); 
        expect(letter).toHaveProperty('rows', 2);
    });

    it('Have property "columns" with the value equal 4', () => {
        const letter = new createLetter('A', 'Afonso', 0, 4); 
        expect(letter).toHaveProperty('columns', 4);
    });
...
describe('Test letter sets', () => {
    ...
    it('Have property "columns" with value 10', () => {
        const letter = new createLetter('A', 'Afonso', 0, 4);
        
        letter.setColumn(10);

        expect(letter.columns).toBe(10);
    });

    it('Have property "rows" with value 10', () => {
        const letter = new createLetter('A', 'Afonso', 0, 4);
        
        letter.setRow(10);

        expect(letter.rows).toBe(10);
    });
